...
public class RoundEntityTest {
	...
	public void should_dto_test() {
		...
		RoundEntity round3 = new RoundEntity(id,movie,movie,movie,Boolean.FALSE , game);
	...
	public void should_dto_convert_test() {
		...
		RoundDTO roundEntity = RoundDTO.builder()
				.id(id)
    			.movieOne(movie)
    			.movieTwo(movie)
    			.movieChosen(movie)
		...
		RoundEntity round = RoundEntity.convertToDTO(roundEntity);
